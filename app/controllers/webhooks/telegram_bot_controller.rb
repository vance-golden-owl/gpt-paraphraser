module Webhooks
  class TelegramBotController < Telegram::Bot::UpdatesController
    ...
    def ping!(*)
      reply_with :message, text: "pong"
    end

    def start!(*)
      reply_with :message, text: "Hello, I am the GPT assistant, what can I do for you?"
    end
    ...
    def gpt_en_chat!(*)
      ...
      reply_with :message, text: reply_content, parse_mode: "Markdown"
    end
    ...
    def gpt_vi_chat!(*)
      ...
      reply_with :message, text: vi_reply, parse_mode: "Markdown"
    end
    ...
    def action_missing(action, *_args)
      if action_type == :command
        reply_with :message, text: "I don't know what the command /#{action_options[:command]} suppose to do, please try to use commands in /help so that I can help you better"
      end
    end
  end
end